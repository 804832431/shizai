...
@interface  MJRefreshBaseView()
{
    ...
    __weak UIWebView *_loadingWebView;
}
@end
...
- (UIWebView *)loadingWebView {
    if (!_loadingWebView) {
        ...
        UIWebView *webView = [[UIWebView alloc] initWithFrame:CGRectMake(arrowX + 15, self.mj_height * 0.5 - 15, 30, 30)];
...
- (void)layoutSubviews
{
    ...
    // 3.loading 动图
    self.loadingWebView.center = CGPointMake(arrowX - 15, self.mj_height * 0.5 - 15);
}
