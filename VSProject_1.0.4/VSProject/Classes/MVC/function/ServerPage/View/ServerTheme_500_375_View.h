...
@protocol Server_500_375_TopicClickedDelegate <NSObject>

- (void)topic_500_375_ClickedAction:(TopicProductDTO *)dto;

@end

@interface ServerTheme_500_375_View : UIView

@property (nonatomic, strong) TopicProductDTO *topicProductDTO;

@property (nonatomic, weak) id<Server_500_375_TopicClickedDelegate> delegate;
