...
@interface ServerTheme_500_375_View ()
...
@implementation ServerTheme_500_375_View
...
- (UILabel *)titleLabel {
    ...
    if (!_titleLabel) {
        ...
        _titleLabel.frame = CGRectMake(Get750Height(24.0f), Get750Width(42.0f), Get750Width(500.0f - 48.0f), Get750Width(36.0f));
...
- (UIImageView *)themeImageView {
    ...
    if (!_themeImageView) {
        ...
        _themeImageView.frame = CGRectMake(0, Get750Width(161.0f), Get750Width(500.0f), Get750Width(214.0f));
    }
...
- (void)clickedAction:(UITapGestureRecognizer *)recognizer {
    ...
    if (self.delegate) {
        [self.delegate topic_500_375_ClickedAction:self.topicProductDTO];
    }
}
...
- (UIView *)rightLineView {
    ...
    if (!_rightLineView) {
        ...
        _rightLineView.frame = CGRectMake(Get750Width(499.0f), 0, Get750Width(1.0f), Get750Width(375.0f));
